...
public class MiniWebServer {
  public static void main2(String[] args) throws Exception {
    ...
    /*
    // 지정된 패키지에서 @WebSerclet 애노테이션이 붙은 클래스를 모두 찾는다.
    // 1) WebServlet 애노테이션이 붙어 있는 클래스의 이름을 모두 찾아라!
    //QueryFunction<Store,String> 해당애노테이션이붙은클래스이름목록찾는조건  = TypesAnnotated.with(WebServlet.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    //    member.no = 10;
    //    member.name = "dd";
    //    member.email = "asda22sd@naver.com";
    //    member.password = "asdasd";
